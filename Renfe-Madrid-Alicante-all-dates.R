...
arrival_station <- "Alicante"  #Stores the departure (Madrid) and arrival (Alicante) station names as variables.
...
destination_input$sendKeysToElement(list("Alicante"))  #Similar to the departure station, but enters "Alicante".
Sys.sleep(2)
...
Sys.sleep(1) #Finds and selects "ALICANTE/ALACANT" from the dropdown.
